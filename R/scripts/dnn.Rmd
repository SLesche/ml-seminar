...
x_train = train_ohe %>% select(-G3) %>% data.matrix()
y_train = train_ohe %>% select(G3) %>% data.matrix()
x_test = test_ohe %>% select(-G3) %>% data.matrix()
y_test = test_ohe %>% select(G3 )%>% data.matrix()
